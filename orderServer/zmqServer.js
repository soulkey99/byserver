...
server.bind('tcp://' + serverConfig.orderServer.host + ':' + serverConfig.orderServer.port);
log.fatal('orderServer zmq service listening at: ' + serverConfig.orderServer.port);
console.log('orderServer zmq service listening at: ' + serverConfig.orderServer.port);
server.on('error', function (err) {
    log.error('order zmq server error: ' + err.message);
});
